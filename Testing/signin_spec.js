describe('menuApp signIn Test', function() {

  it('should sign in and go to restaurant listing', function() {
    ...
    expect(browser.getCurrentUrl()).toEqual('http://localhost:8000/#/restaurantList');
  });
});
